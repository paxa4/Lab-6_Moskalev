...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        shadering.uniform_set_vec(shader_program, "viewPos",
            cameraPosition.x, cameraPosition.y, cameraPosition.z);

        glm::mat3 normalMatrix = glm::transpose(glm::inverse(glm::mat3(modelMatrix)));
        shadering.uniform_set_vec(shader_program, "normalMatrix", 1,
            glm::value_ptr(normalMatrix), GL_FALSE, Shader_loader::M3);
    }
    glfwTerminate();
    return 0;
}
